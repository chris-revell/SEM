...
!**********
  ...
  contains
    ...
    subroutine scem_input
      ...
      epi_adhesion      = 5.0 ! Magnitude of mutual adhesion between epiblasts (type 1)
      hypo_adhesion     = 5.0 ! Magnitude of mutual adhesion between primitive endoderm (type 2)
