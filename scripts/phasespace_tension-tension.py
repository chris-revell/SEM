...
for measurement in measurements:
    ...
    fig,ax = plt.subplots()
    cax = ax.imshow(phasespace_final,vmin=0,vmax=1,cmap="Reds",extent=[0.5,4.5,0.125,1.125],interpolation="bilinear")
    ...
    cax = ax.imshow(phasespace_mean,cmap="Reds",extent=[0.5,4.5,0.125,1.125],interpolation="bilinear")
    if "neighbour" in measurement:
