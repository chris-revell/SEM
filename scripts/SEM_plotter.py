...
if os.path.exists(os.path.join(inputfolder_sorting,"neighbours.txt")):
    ...
    if os.path.exists(os.path.join(inputfolder_randomised,"neighbours.txt")):
        ...
        fig8.savefig(os.path.join(plot_folder,"neighbours_normalised.png"))
...
if os.path.exists(os.path.join(inputfolder_sorting,"radius.txt")):
    ...
    ax3_1.set_ylim([np.amin(data_radius[:,1]),np.amax(data_radius[:,1])])
    ...
    if os.path.exists(os.path.join(inputfolder_randomised,"radius.txt")):
        ...
        fig10 = plt.figure()
        ax10 = fig3.add_subplot(211)
        ax10.set_title("Mean of radius of epiblast cells as a fraction of maximum radius from system centre\n of mass against time, normalised by randomised measurements",y=1.05)
        ...
        fig3.savefig(os.path.join(plot_folder,"radius_normalised.png"))
...
if os.path.exists(os.path.join(inputfolder_sorting,"type_radius1.txt")):
    if os.path.exists(os.path.join(inputfolder_sorting,"type_radius2.txt")):
        ...
        type_radius_time_mean1,bin_edges,binnumber = binned_statistic(data_type_radius1[:,0],data_type_radius1[:,1],bins=200)
        ax4_2.plot((bin_edges[0:200]+(bin_edges[1]-bin_edges[0])/2.0),type_radius_time_mean1,color="Green",linewidth=3,label="Epi")
        type_radius_time_mean2,bin_edges,binnumber = binned_statistic(data_type_radius2[:,0],data_type_radius2[:,1],bins=200)
        ax4_2.plot((bin_edges[0:200]+(bin_edges[1]-bin_edges[0])/2.0),type_radius_time_mean2,color="Red",linewidth=3,label="PrE")
        ...
        type_radius_age_mean1,bin_edges,binnumber = binned_statistic(data_type_radius1[:,2],data_type_radius1[:,1],bins=100)
        ax5_2.plot((bin_edges[0:100]+(bin_edges[1]-bin_edges[0])/2.0),type_radius_age_mean1,color="Green",linewidth=5,label="Epi")
        type_radius_age_mean2,bin_edges,binnumber = binned_statistic(data_type_radius2[:,2],data_type_radius2[:,1],bins=100)
        ax5_2.plot((bin_edges[0:100]+(bin_edges[1]-bin_edges[0])/2.0),type_radius_age_mean2,color="Red",linewidth=5,label="PrE")
        ...
        if os.path.exists(os.path.join(inputfolder_randomised,"type_radius1.txt")):
            ...
            type_radius_age_random_mean1,bin_edges,binnumber = binned_statistic(data_type_radius_random1[:,2],data_type_radius_random1[:,1],bins=100)
            ax7.plot(bin_edges[0:100]+(bin_edges[1]-bin_edges[0])/2.0,type_radius_age_mean1-type_radius_age_random_mean1,color="Green",label="Epi",lw=5)
            type_radius_age_random_mean2,bin_edges,binnumber = binned_statistic(data_type_radius_random2[:,2],data_type_radius_random2[:,1],bins=100)
            ax7.plot(bin_edges[0:100]+(bin_edges[1]-bin_edges[0])/2.0,type_radius_age_mean2-type_radius_age_random_mean2,color="Red",label="PrE",lw=5)
            ax7.set_title("Distance of cells of each type from the centre of mass of that type\n against cell age, normalised by randomised measurements")
            ax7.set_xlabel("Cell age")
            ...
            type_radius_age_random_mean1,bin_edges,binnumber = binned_statistic(data_type_radius_random1[:,2],data_type_radius_random1[:,1],bins=100)
            ax11.plot(bin_edges[0:100]+(bin_edges[1]-bin_edges[0])/2.0,type_radius_age_mean1-type_radius_age_random_mean1,color="Green",label="Epi",lw=5)
            type_radius_age_random_mean2,bin_edges,binnumber = binned_statistic(data_type_radius_random2[:,2],data_type_radius_random2[:,1],bins=100)
            ax11.plot(bin_edges[0:100]+(bin_edges[1]-bin_edges[0])/2.0,type_radius_age_mean2-type_radius_age_random_mean2,color="Red",label="PrE",lw=5)
