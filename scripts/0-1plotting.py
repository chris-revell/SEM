...
fig1.savefig(os.path.join(argv[1],"0-1plots","neighbours0-1.png"),bbox_inches="tight")
...
fig2.savefig(os.path.join(argv[1],"0-1plots","surface0-1.png"),bbox_inches="tight")
...
fig3.savefig(os.path.join(argv[1],"0-1plots","radius0-1.png"),bbox_inches="tight")
