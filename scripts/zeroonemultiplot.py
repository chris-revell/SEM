...
folderstoignore = ["p_values","meandata","meanplots","0-1data","0-1plots","3sigmadata","3sigmaplots","4sigmadata","4sigmaplots"]
...
for folder in ["3sigma","4sigma"]:
    datafolder = os.path.join(argv[1],folder+"data")
    plotfolder = os.path.join(argv[1],folder+"plots")
    ...
    for i in runs:
        zerooneplotting.zeroonemeasurements(i,0,int(folder[0]))
