...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/surface.txt")):
    ...
    ax5.errorbar(100,zeromean_surface1,yerr=(zerostd_surface1),color="Green",ls="none")
    ax5.errorbar(0,zeromean_surface2,yerr=(zerostd_surface2),color="Red",ls="none")
    ...
    ax5.scatter(100,zeromean_surface1,color="Green")
    ax5.scatter(0,zeromean_surface2,color="Red")
    ...
    bin_edges = np.append([0],bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0)
    surface_mean1 = np.append(zeromean_surface1,surface_mean1)
    surface_std1 = np.append(zerostd_surface1,surface_std1)
    surface_mean2 = np.append(zeromean_surface2,surface_mean2)
    surface_std2 = np.append(zerostd_surface2,surface_std2)
    np.savetxt(os.path.join(argv[1],"surface.txt"),np.stack((bin_edges,surface_mean1,surface_std1,surface_mean2,surface_std2),axis=1))
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/neighbours.txt")):
    ...
    ax6.scatter(200,neighbours_zeromean1,color="Green")
    ax6.scatter(100,neighbours_zeromean2,color="Red")
    ax6.scatter(0,neighbours_zeromean3,color="Blue")
...
"""
    ...
    if os.path.exists(os.path.join(datafolders[0],"randomised_data/surface.txt")):
        ...
        fig6.set_tight_layout(True)
        fig6.savefig(os.path.join(argv[1],"surface_random.png"))
