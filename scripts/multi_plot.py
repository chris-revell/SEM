...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/type_radius1.txt")):
    ...
    outstd1 = np.append(tr_age_zerostd1/errordivisor,tr_age_std1/errordivisor)
    outmean2 = np.append(tr_age_zeromean2,tr_age_mean2)
    outstd2 = np.append(tr_age_zerostd2/errordivisor,tr_age_std2/errordivisor)
    fig1 = plt.figure()
    ...
    outstd1 = np.append(tr_time_zerostd1/errordivisor,tr_time_std1/errordivisor)
    outmean2 = np.append(tr_time_zeromean2,tr_time_mean2)
    outstd2 = np.append(tr_time_zerostd2/errordivisor,tr_time_std2/errordivisor)
    fig2 = plt.figure()
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/surface.txt")):
    ...
    outstd1 = np.append(zerostd_surface1/errordivisor,surface_std1/errordivisor)
    outmean2 = np.append(zeromean_surface2,surface_mean2)
    outstd2 = np.append(zerostd_surface2/errordivisor,surface_std2/errordivisor)
    fig5 = plt.figure()
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/neighbours.txt")):
    ...
    outstd1      = np.append(neighbours_zerostd1/errordivisor,neighbours_std1/errordivisor)
    outmean2     = np.append(neighbours_zeromean2,neighbours_mean2)
    outstd2      = np.append(neighbours_zerostd2/errordivisor,neighbours_std2/errordivisor)
    outmean3     = np.append(neighbours_zeromean3,neighbours_mean3)
    outstd3      = np.append(neighbours_zerostd3/errordivisor,neighbours_std3/errordivisor)
    fig6 = plt.figure()
    ...
    outstd      = np.append(neighboursdifzerostd/errordivisor,neighboursdifstd/errordivisor)
    fig13 = plt.figure()
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/com.txt")):
    ...
    outstd      = np.append(com_zerostd/errordivisor,com_std/errordivisor)
    fig8 = plt.figure()
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/velocity1.txt")):
    ...
    v_age_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity1[:,2],combined_velocity1[:,1],statistic=np.std,bins=5)
    v_age_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity2[:,2],combined_velocity2[:,1],statistic=np.std,bins=5)
    v_age_zerostd1 = np.std(zeroagedata1)
    v_age_zerostd2 = np.std(zeroagedata2)
    outbin_edges = np.append([0],bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0)
    outmean1 = np.append(v_age_zeromean1,v_age_mean1)
    outstd1 = np.append(v_age_zerostd1/errordivisor,v_age_std1/errordivisor)
    outmean2 = np.append(v_age_zeromean2,v_age_mean2)
    outstd2 = np.append(v_age_zerostd2/errordivisor,v_age_std2/errordivisor)
    fig9 = plt.figure()
    ...
    v_radius_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity1[:,0],combined_velocity1[:,1],statistic=np.std,bins=5)
    v_radius_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity2[:,0],combined_velocity2[:,1],statistic=np.std,bins=5)
    outbin_edges = bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0
    outmean1 = v_radius_mean1
    outstd1 = v_radius_std1/errordivisor
    outmean2 = v_radius_mean2
    outstd2 = v_radius_std2/errordivisor
    fig10 = plt.figure()
    ax10 = fig10.add_subplot(111)
    ax10.errorbar(outbin_edges+100,outmean1,yerr=(outstd1),color="Green",ls="none")
    ax10.errorbar(outbin_edges,outmean2,yerr=(outstd2),color="Red",ls="none")
    ax10.scatter(outbin_edges+100,outmean1,color="Green",label="Epi")
