...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/type_radius1.txt")):
    ...
    tr_age_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_typeradius1[:,2],combined_typeradius1[:,1],statistic=scipy.stats.sem,bins=5)
    tr_age_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_typeradius2[:,2],combined_typeradius2[:,1],statistic=scipy.stats.sem,bins=5)
    ...
    tr_time_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_typeradius1[:,0],combined_typeradius1[:,1],statistic=scipy.stats.sem,bins=5)
    tr_time_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_typeradius2[:,0],combined_typeradius2[:,1],statistic=scipy.stats.sem,bins=5)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/surface.txt")):
    ...
    surface_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_surface[:,0],combined_surface[:,1],statistic=scipy.stats.sem,bins=5)
    surface_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_surface[:,0],combined_surface[:,2],statistic=scipy.stats.sem,bins=5)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/neighbours.txt")):
    ...
    neighbours_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_neighbours[:,0],combined_neighbours[:,1],statistic=scipy.stats.sem,bins=5)
    neighbours_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_neighbours[:,0],combined_neighbours[:,2],statistic=scipy.stats.sem,bins=5)
    neighbours_std3,bin_edges,binnumber = scipy.stats.binned_statistic(combined_neighbours[:,0],combined_neighbours[:,3],statistic=scipy.stats.sem,bins=5)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/com.txt")):
    ...
    com_std,bin_edges,binnumber = scipy.stats.binned_statistic(combined_com[:,0],combined_com[:,1],statistic=scipy.stats.sem,bins=5)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/velocity1.txt")):
    ...
    v_age_mean1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity1[:,2],combined_velocity1[:,1],bins=5)
    v_age_mean2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity2[:,2],combined_velocity2[:,1],bins=5)
    v_age_zeromean1 = np.mean(zeroagedata1)
    v_age_zeromean2 = np.mean(zeroagedata2)
    v_age_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity1[:,2],combined_velocity1[:,1],statistic=scipy.stats.sem,bins=5)
    v_age_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity2[:,2],combined_velocity2[:,1],statistic=scipy.stats.sem,bins=5)
    ...
    v_radius_mean2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity2[:,0],combined_velocity2[:,1],bins=5)
    v_radius_std1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity1[:,0],combined_velocity1[:,1],statistic=scipy.stats.sem,bins=5)
    v_radius_std2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_velocity2[:,0],combined_velocity2[:,1],statistic=scipy.stats.sem,bins=5)
    ...
    if os.path.exists(os.path.join(datafolders[0],"randomised_data/velocity1.txt")):
        ...
        #Type radius against cell age:
        v_age_random_mean1,bin_edges,binnumber = scipy.stats.binned_statistic(combined_random_velocity1[:,2],combined_random_velocity1[:,1],bins=5)
        v_age_random_mean2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_random_velocity2[:,2],combined_random_velocity2[:,1],bins=5)
        ...
        v_radius_random_mean2,bin_edges,binnumber = scipy.stats.binned_statistic(combined_random_velocity2[:,0],combined_random_velocity2[:,1],bins=5)
        outbin_edges = bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0
