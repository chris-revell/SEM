...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/type_radius1.txt")):
    ...
    tr_age_std1,bin_edges,binnumber = binned_statistic(combined_typeradius1[:,2],combined_typeradius1[:,1],statistic=sem,bins=5)
    tr_age_std2,bin_edges,binnumber = binned_statistic(combined_typeradius2[:,2],combined_typeradius2[:,1],statistic=sem,bins=5)
    ...
    fig1.savefig(os.path.join(plotfolder,"radius_age.png"),bbox_inches="tight",dpi=500)
    ...
    tr_time_std1,bin_edges,binnumber = binned_statistic(combined_typeradius1[:,0],combined_typeradius1[:,1],statistic=sem,bins=5)
    tr_time_std2,bin_edges,binnumber = binned_statistic(combined_typeradius2[:,0],combined_typeradius2[:,1],statistic=sem,bins=5)
    ...
    fig2.savefig(os.path.join(plotfolder,"radius_time.png"),bbox_inches="tight",dpi=500)
    ...
    if os.path.exists(os.path.join(datafolders[0],"randomised_data/type_radius1.txt")):
        ...
        fig3.savefig(os.path.join(plotfolder,"radius_age_normalised.png"),bbox_inches="tight",dpi=500)
        ...
        fig4.savefig(os.path.join(plotfolder,"radius_time_normalised.png"),bbox_inches="tight",dpi=500)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/surface.txt")):
    ...
    surface_std1,bin_edges,binnumber = binned_statistic(combined_surface[:,0],combined_surface[:,1],statistic=sem,bins=5)
    surface_std2,bin_edges,binnumber = binned_statistic(combined_surface[:,0],combined_surface[:,2],statistic=sem,bins=5)
    zerostd_surface1 = sem(np.array(zerolist_surface1))
    zerostd_surface2 = sem(np.array(zerolist_surface2))
    outbin_edges = np.append([0],bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0)
    ...
    fig5.savefig(os.path.join(plotfolder,"surface.png"),bbox_inches="tight",dpi=500)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/neighbours.txt")):
    ...
    neighbours_std1,bin_edges,binnumber = binned_statistic(combined_neighbours[:,0],combined_neighbours[:,1],statistic=sem,bins=5)
    neighbours_std2,bin_edges,binnumber = binned_statistic(combined_neighbours[:,0],combined_neighbours[:,2],statistic=sem,bins=5)
    neighbours_std3,bin_edges,binnumber = binned_statistic(combined_neighbours[:,0],combined_neighbours[:,3],statistic=sem,bins=5)
    neighbours_zerostd1 = sem(zeroneighboursdata1)
    neighbours_zerostd2 = sem(zeroneighboursdata2)
    neighbours_zerostd3 = sem(zeroneighboursdata3)
    outbin_edges = np.append([0],bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0)
    ...
    fig6.savefig(os.path.join(plotfolder,"neighbours.png"),bbox_inches="tight",dpi=500)
    ...
    if os.path.exists(os.path.join(datafolders[0],"randomised_data/neighbours.txt")):
        ...
        fig7.savefig(os.path.join(plotfolder,"neighbours_normalised.png"),bbox_inches="tight",dpi=500)
    ...
    neighboursdifstd,bin_edges,binnumber = binned_statistic(combined_neighbour_dif[:,0],combined_neighbour_dif[:,1],statistic=sem,bins=5)
    neighboursdifzerostd = sem(zeroneighbourdif)
    outbin_edges = np.append([0],bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/com.txt")):
    ...
    com_std,bin_edges,binnumber = binned_statistic(combined_com[:,0],combined_com[:,1],statistic=sem,bins=5)
    com_zerostd = sem(zerocomdata)
    outbin_edges = np.append([0],bin_edges[0:5]+(bin_edges[1]-bin_edges[0])/2.0)
...
if os.path.exists(os.path.join(datafolders[0],"sorting_data/velocity1.txt")):
    ...
    v_age_std1,bin_edges,binnumber = binned_statistic(combined_velocity1[:,2],combined_velocity1[:,1],statistic=sem,bins=5)
    v_age_std2,bin_edges,binnumber = binned_statistic(combined_velocity2[:,2],combined_velocity2[:,1],statistic=sem,bins=5)
    ...
    fig9.savefig(os.path.join(plotfolder,"velocity_age.png"),bbox_inches="tight",dpi=500)
    ...
    v_radius_std1,bin_edges,binnumber = binned_statistic(combined_velocity1[:,0],combined_velocity1[:,1],statistic=sem,bins=5)
    v_radius_std2,bin_edges,binnumber = binned_statistic(combined_velocity2[:,0],combined_velocity2[:,1],statistic=sem,bins=5)
    ...
    fig10.savefig(os.path.join(plotfolder,"velocity_radius.png"),bbox_inches="tight",dpi=500)
    ...
    if os.path.exists(os.path.join(datafolders[0],"randomised_data/velocity1.txt")):
        ...
        fig11.savefig(os.path.join(plotfolder,"velocity_age_normalised.png"),bbox_inches="tight",dpi=500)
        ...
        fig12.savefig(os.path.join(plotfolder,"velocity_radius_normalised.png"),bbox_inches="tight",dpi=500)
