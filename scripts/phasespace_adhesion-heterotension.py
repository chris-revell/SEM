...
for measurement in measurements:
    ...
    cax = ax.imshow(phasespace_final,vmin=0,vmax=1,cmap="Reds",extent=[0.5,4.5,0.375,3.375],interpolation="bilinear")
    ...
    ax.set_xlabel("Epiblast Heterotypic Interface Tension Factor")
    ax.set_yticks(y)
    ...
    """
    fig,ax = plt.subplots()#figsize=(9,6))
    cax = ax.imshow(phasespace_mean,cmap="Reds",extent=[0.5,4.5,0.375,3.375],interpolation="bilinear")
    if "neighbour" in measurement:
