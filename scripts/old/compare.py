...
pyplot.savefig(os.path.join(outputfolder,'radius.png'))
"""
pyplot.figure(2)
lims = pyplot.xlim()
...
pyplot.savefig(os.path.join(outputfolder,'interface.png'))
"""
pyplot.figure(3)
lims = pyplot.xlim()
...
pyplot.savefig(os.path.join(outputfolder,'neighbours.png'))
