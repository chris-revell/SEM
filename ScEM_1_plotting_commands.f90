...
contains
  ...
  write(45,'(A51)',advance="no") 'plot "data/system_data/cell_volumes.txt" using 1:2 '
  write(45,'(A26)',advance="no") 'title "cell  2" with lines'
  if (nc.GT.1) then
    do n=2, nc
      write(45,'(A46)',advance="no") ', "data/system_data/cell_volumes.txt" using 1:'
      write(45,'(I2.2,A12)',advance="no") n+1, 'title "cell '
      write(45,'(I2.2,A12)',advance="no") n, '" with lines'
    enddo
  endif
