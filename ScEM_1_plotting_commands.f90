...
contains
  ...
  write(45,*) 'set output "'//output_folder//'/system_data/sorting_neighbours.png"'
  ...
  write(45,*) 'plot "'//output_folder//'/system_data/sorting_data_neighbours.txt" with lines'
  write(45,*)
  ...
  write(45,*) 'set output "'//output_folder//'/system_data/sorting_radius.png"'
  write(45,*) 'set xlabel "Time /s"'
  ...
  write(45,*) 'plot "'//output_folder//'/system_data/sorting_data_radius.txt" with lines'
  write(45,*)

  write(45,*) 'set nokey'
  write(45,*) 'set terminal png'
  write(45,*) 'set title "Element pair sorting measurement against time"'
  write(45,*) 'set output "'//output_folder//'/system_data/sorting_element_pairs.png"'
  write(45,*) 'set xlabel "Time /s"'
  write(45,'(A48)',advance='no') ' set ylabel "Ratio of same fate element pairs \n'
  write(45,*) 'to total number of element pairs"'
  write(45,*) 'set yrange [0:1]'
  write(45,*) 'plot "'//output_folder//'/system_data/sorting_data.txt" with lines'
  write(45,*)
  ...
  write(45,*) 'set output "'//output_folder//'/system_data/cell_count.png"'
  write(45,*) 'set xlabel "Time /s"'
  write(45,*) 'set ylabel "Number of cells in system"'
  write(45,*) 'plot "'//output_folder//'/system_data/cell_count.txt" with lines'
  write(45,*)
